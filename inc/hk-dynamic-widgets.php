...
function hk_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => 'Startsidans sidof&auml;lt (hamnar &ouml;ver "Startsidans inneh&aring;ll" i mobilstorlek)',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
	...
	register_sidebar( array(
		...
		'description' => 'Startsidans sidof&auml;lt (hamnar under "Startsidans inneh&aring;ll" i mobilstorlek)',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h1 class="widget-title"><span>',
		'after_title' => '</span></h1>',
