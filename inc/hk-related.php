				...
				if (get_field('hk_related')) :
					while (has_sub_field('hk_related')) : 
						if ( get_row_layout() == 'hk_related_posts' ) : 
							$retValue .= "<li class='related_page'><a title='Relaterat inl&auml;gg' class='aside-icon-left'><i class='i' data-icon='&#xF179;'></i></a>";
							$value = get_sub_field('hk_related_post');
							$retValue .= "<a href='" . get_permalink($value->ID) . "' class='aside-icon-right' title='" . get_sub_field('hk_related_post_description') . "'>" . $value->post_title . "</a>";
							$retValue .= "</li>";		 
						elseif ( get_row_layout() == 'hk_related_links' ) : 
							$retValue .= "<li class='related_link'><a title='L&auml;nk till annan webbsida' class='aside-icon-left'><i class='i' data-icon='&#xF02E;'></i></a>";
							...
							$retValue .= "<a target='_blank' class='aside-icon-right' href='" . $relate_link_url . "' title='" . get_sub_field('hk_related_link_description') . "'>" . get_sub_field('hk_related_link_name') . "</a>";
							$retValue .= "</li>";
						elseif ( get_row_layout() == 'hk_related_files' ) :
							...
							$retValue .= "<li class='related_file'><a title='Ladda ner dokument' class='aside-icon-left'><i class='i' data-icon='&#xF02C;'></i></a>";
								$retValue .= "<a target='_blank' class='aside-icon-right' href='" . $link . "' title='" . get_sub_field('hk_related_file_description') . "'>" . $link_name . "</a>";
							$retValue .= "</li>";
						endif;
