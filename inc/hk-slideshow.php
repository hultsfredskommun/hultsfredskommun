...
function hk_slideshow_generate_output($vars) {
	...
	if ( !empty($selected_categories) )
	{
		...
		if ($meta_query->have_posts()) {
			$retValue .= "<div class='img-wrapper'><div class='slideshow'><img alt='Platsh&aring;llare f&ouml;r bildspel' class='slideshow_bg' src='" . get_stylesheet_directory_uri() . "/image.php?w=".$default_settings[$vars["thumbnail-size"]][0]."&amp;h=".($default_settings[$vars["thumbnail-size"]][1])."'/>";
