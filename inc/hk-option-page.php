...
function hk_theme_options_do_page() {
	...
	<div class="wrap">
		...
		<form id="form_hk_options" method="post" action="options.php">
			...
			<p><input type="checkbox" name="hk_theme[gcse_ajax]" value="1"<?php checked( 1 == $options['gcse_ajax'] ); ?> /> <label for="hk_theme[gcse_ajax]">Använd AJAX-sökning som även lägger till snabbträffar i dropdown, fungerar bara i kombination med att ID ovan är angett.</label></p>
			<p><input type="checkbox" name="hk_theme[gcse_enable_kontakter_search]" value="1"<?php checked( 1 == $options['gcse_enable_kontakter_search'] ); ?> /> <label for="hk_theme[gcse_enable_kontakter_search]">Sök specifikt i kontakter, fungerar bara i kombination med att ID ovan är angett och ajax-sökning.</label></p>
			<p><input type="checkbox" name="hk_theme[gcse_enable_faq_search]" value="1"<?php checked( 1 == $options['gcse_enable_faq_search'] ); ?> /> <label for="hk_theme[gcse_enable_faq_search]">Sök specifikt i vanliga fr&aring;gor, fungerar bara i kombination med att ID ovan är angett och ajax-sökning.</label></p>
			<p><label for="hk_theme[faq_search_ignore_words]">Ord som ska nerprioriteras vid sökning.</label><br/><input type="text" size="80" name="hk_theme[faq_search_ignore_words]" value="<?php echo $options['faq_search_ignore_words']; ?>" /></p>
