...
function hk_theme_options_do_page() {
	...
	<div class="wrap">
      ...
      <p><input type="checkbox" name="hk_theme[new_mobile_menu]" value="1"<?php checked( 1 == $options['new_mobile_menu'] ); ?> /> <label for="hk_theme[new_mobile_menu]">EN mobilmeny istället för delad.</label></p>
			<p><input type="checkbox" name="hk_theme[toggle_filter_categories]" value="1"<?php checked( 1 == $options['toggle_filter_categories'] ); ?> /> <label for="hk_theme[toggle_filter_categories]">Visa filter på kategorier.</label></p>
